...
// 2023-07-26 인증ID 사용을 위해 AuthenticationPrincipal 추가 및 temporary-user 사용부분 삭제
// 계정 2개 생성하여 각 토큰을 사용해 todo 아이템을 추가하면 각 계정별로 생성한 todo만 보인다.
@RestController
@RequestMapping("todo")
public class TodoController {
	...
	public ResponseEntity<?> createTodo(@AuthenticationPrincipal String userId, @RequestBody TodoDTO dto) {
		...
		try {
			...
			// @AuthenticationPrincipal을 사용하며 Authentication Bearer Token을 통해 받은 userId를 넘긴다.
